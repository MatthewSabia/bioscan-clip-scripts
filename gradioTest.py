...
def searchEmbeddings(id):
    ...
    # get images
    image1 = get_image(dataset_hdf5_all_key, dataset_image_mask, processid_to_index, indx_to_id_dict[I[0][0]])
    image2 = get_image(dataset_hdf5_all_key, dataset_image_mask, processid_to_index, indx_to_id_dict[I[0][1]])
    image3 = get_image(dataset_hdf5_all_key, dataset_image_mask, processid_to_index, indx_to_id_dict[I[0][2]])
    image4 = get_image(dataset_hdf5_all_key, dataset_image_mask, processid_to_index, indx_to_id_dict[I[0][3]])
    image5 = get_image(dataset_hdf5_all_key, dataset_image_mask, processid_to_index, indx_to_id_dict[I[0][4]])
    image6 = get_image(dataset_hdf5_all_key, dataset_image_mask, processid_to_index, indx_to_id_dict[I[0][5]])
    image7 = get_image(dataset_hdf5_all_key, dataset_image_mask, processid_to_index, indx_to_id_dict[I[0][6]])
    image8 = get_image(dataset_hdf5_all_key, dataset_image_mask, processid_to_index, indx_to_id_dict[I[0][7]])
    image9 = get_image(dataset_hdf5_all_key, dataset_image_mask, processid_to_index, indx_to_id_dict[I[0][8]])
    image10 = get_image(dataset_hdf5_all_key, dataset_image_mask, processid_to_index, indx_to_id_dict[I[0][9]])
